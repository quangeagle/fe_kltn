...
function SuppliersPage() {
  ...
  const filteredSuppliers = suppliers
    .filter(supplier => {
      const matchesSearch = supplier.storeName?.toLowerCase().includes(searchTerm.toLowerCase()) ||
                          supplier.ownerName?.toLowerCase().includes(searchTerm.toLowerCase()) ||
                          supplier.storeAddress?.toLowerCase().includes(searchTerm.toLowerCase());
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="px-6 py-12">
        <div className="max-w-7xl mx-auto">
          {/* Page Header */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-white mb-4">Nhà cung cấp</h1>
            <p className="text-gray-400">Khám phá các nhà cung cấp uy tín và chất lượng</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="owner">Sắp xếp theo chủ cửa hàng</option>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredSuppliers.map((supplier) => (
              <div key={supplier._id} className="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-purple-500 transition-all duration-300 group">
                <Link to={`/supplier/${supplier._id}`} className="block">
                  <div className="text-center mb-6">
                    ...
                    <h3 className="text-white font-semibold text-lg mb-2 group-hover:text-purple-400 transition-colors">
                      {supplier.storeName || 'Cửa hàng'}
                    </h3>
                    {supplier.ownerName && (
                      <p className="text-gray-400 text-sm mb-2">
                        Chủ cửa hàng: {supplier.ownerName}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    {supplier.storeAddress && (
                      <div className="flex items-start space-x-2 text-gray-300 text-sm">
                        ...
                        <span className="line-clamp-2">{supplier.storeAddress}</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-700">
                    <div className="flex justify-between text-sm">
                      <div className="text-center">
                        <div className="text-white font-semibold">{(Math.random() * 100 + 50).toFixed(0)}</div>
                        <div className="text-gray-400">Sản phẩm</div>
                      </div>
                      <div className="text-center">
                        <div className="text-white font-semibold">{(Math.random() * 1000 + 100).toFixed(0)}</div>
                        <div className="text-gray-400">Đánh giá</div>
                      </div>
                      <div className="text-center">
                        <div className="text-white font-semibold">{(Math.random() * 5 + 4).toFixed(1)}⭐</div>
                        <div className="text-gray-400">Điểm</div>
                      </div>
                    </div>
                  </div>
                </Link>
                ...
                <div className="flex space-x-2 mt-4">
                  <Link 
                    ...
                    className="flex-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white py-2 rounded-lg text-sm font-semibold hover:from-purple-600 hover:to-pink-600 transition-all text-center"
                  >
                    Xem chi tiết
                  </Link>
                  <Link 
                    to={`/supplier/${supplier._id}/products`}
          ...
          {filteredSuppliers.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Không tìm thấy nhà cung cấp</h3>
