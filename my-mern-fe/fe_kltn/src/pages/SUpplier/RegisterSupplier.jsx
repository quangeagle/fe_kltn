...
const RegisterSupplier = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('https://be-kltn-1.onrender.com/api/suppliers/register', data, {
        headers: {
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-gray-800 rounded-2xl border border-gray-700 p-8">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-white mb-2">Đăng ký nhà cung cấp</h2>
              <p className="text-gray-400">Tạo tài khoản để bắt đầu kinh doanh</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-white text-sm font-medium mb-2">Tên cửa hàng *</label>
                  <input 
                    type="text" 
                    name="storeName" 
                ...
                <div>
                  <label className="block text-white text-sm font-medium mb-2">Chủ cửa hàng</label>
                  <input 
                    type="text" 
                    name="ownerName" 
              ...
              <div>
                <label className="block text-white text-sm font-medium mb-2">Địa chỉ cửa hàng</label>
                <input 
                  type="text" 
                  name="storeAddress" 
              ...
              <div>
                <label className="block text-white text-sm font-medium mb-2">Ảnh đại diện</label>
              ...
              <div className="text-center">
                ...
                <Link to="/auth" className="text-purple-400 text-sm font-medium hover:text-purple-300 transition-colors">
                  Đăng nhập
                </Link>
              </div>
            </form>
